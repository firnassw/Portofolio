  ...
  <header className="site-header" id="site-header">
    <div className="header-inner">
      <a href="#top" className="brand">
        <Image src="/logo/logo.png" alt="WF Logo" width={120} height={120} className="brand-logo" />
      </a>
      ...
      <div className="section-inner">
        <div className="about-photo-wrapper">
          <div className="about-photo glass-card" data-reveal>
            <Image src="/logo/foto besar.jpeg" alt="Foto profil" width={400} height={400} loading="lazy" />
          </div>
        ...
        <ol className="timeline">
          <li className="timeline-item" data-reveal>
            <div className="timeline-logo-wrap">
              <Image src="/logo/upn-logo.png" alt="UPN Logo" width={120} height={120} />
            </div>
    ...
    <div className="footer-card">
      <div className="fc-top">
        <div className="fc-col fc-left">
          <Image src="/logo/logo.png" alt="WF Logo" width={120} height={120} className="fc-logo dark-invert" />
        ...
        <div className="fc-col fc-right">
          <div className="fc-socials">
            <a href="https://github.com/firnassw" target="_blank" rel="noopener noreferrer" aria-label="GitHub"><svg
            ...
            <a href="https://www.linkedin.com/in/wahid-firnas/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><svg
                className="social-icon dark-invert" viewBox="0 0 24 24" fill="currentColor">
                <path
            ...
            <a href="https://instagram.com/f.rnass" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><svg
                className="social-icon dark-invert" viewBox="0 0 24 24" fill="currentColor">
                <path
