    ...
    <section className="section section-tint contact-hero-section" id="contact">
      <div className="section-inner contact-grid-new">
        <div className="contact-content-container">
          <div className="pill-label" style={{ "margin": "0 auto 1rem", "display": "inline-flex", "alignSelf": "center" } as React.CSSProperties}>
            <span className="dot"></span> Let's Connect
          </div>
          <h2 className="contact-title" style={{ "marginBottom": "1rem" } as React.CSSProperties}>Contact Me</h2>
          
          <div className="contact-main-card glass-card" style={{ "textAlign": "left" } as React.CSSProperties}>
          <div className="card-header-flex">
            <h3>Let's Connect</h3>
            <div className="send-icon-btn"><span className="material-symbols-outlined">send</span></div>
          </div>
          <p className="card-subtext">Choose the most convenient platform to reach me.</p>

          <div className="platform-list">
            <a href="mailto:firnaswahid@gmail.com" className="platform-item">
              <div className="platform-icon-box blue-box"><span className="material-symbols-outlined">mail</span></div>
              <div className="platform-text">
                <strong>Email</strong>
                <span>firnaswahid@gmail.com</span>
              </div>
              <div className="platform-action"><span className="material-symbols-outlined">content_copy</span></div>
            </a>

            <a href="https://github.com/firnassw" target="_blank" className="platform-item">
              <div className="platform-icon-box dark-box">
              ...
              <div className="platform-text">
                ...
                <span>github.com/firnassw</span>
              </div>
              <div className="platform-action"><span className="material-symbols-outlined">chevron_right</span></div>
            </a>

            <a href="https://www.linkedin.com/in/wahid-firnas/" target="_blank" className="platform-item">
              <div className="platform-icon-box linkedin-box">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                  <path
              ...
              <div className="platform-text">
                ...
                <span>linkedin.com/in/wahid-firnas/</span>
              </div>
              <div className="platform-action"><span className="material-symbols-outlined">chevron_right</span></div>
            </a>

            <a href="https://www.instagram.com/firnassw/" target="_blank" className="platform-item">
              <div className="platform-icon-box insta-box">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                  <path
          ...
          <div className="action-buttons-row">
            <a href="./sertifikat/cv.pdf" target="_blank" className="btn btn-primary btn-block"><span
